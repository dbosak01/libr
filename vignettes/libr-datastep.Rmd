...
# 1  21.0   6 160.0   High 1974-06-10     NA
# 2  21.0   6 160.0   High 1974-06-10     NA
# 3  22.8   4 108.0   High 1974-06-10     NA
# 4  21.4   6 258.0   High 1974-06-10     NA
# 5  18.7   8 360.0    Low 1974-06-10   TRUE
# 6  18.1   6 225.0    Low 1974-06-10     NA
# 7  14.3   8 360.0    Low 1974-06-10   TRUE
# 8  24.4   4 146.7   High 1974-06-10     NA
# 9  22.8   4 140.8   High 1974-06-10     NA
# 10 19.2   6 167.6    Low 1974-06-10     NA
...
# 1  21.0   6 160.0   High 1974-06-10
# 2  21.0   6 160.0   High 1974-06-10
# 3  22.8   4 108.0   High 1974-06-10
# 4  21.4   6 258.0   High 1974-06-10
# 5  18.7   8 360.0    Low 1974-06-10
# 6  18.1   6 225.0    Low 1974-06-10
# 7  14.3   8 360.0    Low 1974-06-10
# 8  24.4   4 146.7   High 1974-06-10
# 9  22.8   4 140.8   High 1974-06-10
# 10 19.2   6 167.6    Low 1974-06-10
...
The keep and drop parameters accepts wildcards. 
The star character ("*") will match multiple characters, while the question 
mark ("?") matches a single character.  Wildcard characters can be placed 
anywhere in the column name string.

#### Example 4: Keep Wildcard
```{r eval=FALSE, echo=TRUE}
# Keep with wildcard
df <- datastep(mtcars[1:10,], 
  keep = c("mpg", "cyl", "d*", "mpgcat"), {
...
df
#     mpg cyl  disp drat mpgcat
# 1  21.0   6 160.0 3.90   High
# 2  21.0   6 160.0 3.90   High
# 3  22.8   4 108.0 3.85   High
# 4  21.4   6 258.0 3.08   High
# 5  18.7   8 360.0 3.15    Low
# 6  18.1   6 225.0 2.76    Low
# 7  14.3   8 360.0 3.21    Low
# 8  24.4   4 146.7 3.69   High
# 9  22.8   4 140.8 3.92   High
# 10 19.2   6 167.6 3.92    Low
...
#### Example 10: Using a Data Step Array
```{r eval=FALSE, echo=TRUE}
library(libr)
...
To increase performance, reduce the number of rows
...
#### Example 11: Increasing Performance
